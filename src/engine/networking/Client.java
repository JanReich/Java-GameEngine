...
public abstract class Client {
  ...
  public Client(final String hostname, final int port, final int timeout) {
   ...
   */
  public Client(final String hostname, final int port, final String id) {
   ...
   *                 werden können.
   */
  public Client(final String hostname, final int port, final String id, final String group) {
   ...
   *                 werden können.
   */
  public Client(final String hostname, final int port, final int timeout, final String id, final String group) {
    this.id = id;
    this.group = group;
    this.errorCount = 0;
   ...
   */
  public Datapackage sendMessage(final Datapackage message, final int timeout) {
    try {
   ...
   */
  public Datapackage sendMessage(final String id, final Object... content) {
   ...
   */
  public Datapackage sendMessage(final Datapackage message) {
   ...
   */
  public abstract void onMessageReceived(final Datapackage pack, final Socket socket);
